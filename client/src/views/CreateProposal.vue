            ...
            <div class= "col-md-6">
                ...
                <div v-else-if = "stepFour.strategy ===  'whitelist'">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <button type="button"  class="btn btn-success fw-bolder py-2" style="width: 50%; font-size: 14px;"><a href="http://localhost:5000/download" style="color: #fff;">Download boilerplate whitelist.xlsx</a></button>
